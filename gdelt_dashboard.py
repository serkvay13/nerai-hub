...
with st.sidebar:
    ...
    st.markdown("""<div style="position:fixed;top:50%;left:50%;transform:translate(-50%,-50%) rotate(-35deg);pointer-events:none;z-index:1;opacity:0.025;"><div style="display:flex;align-items:center;gap:20px;"><svg width="100" height="100" viewBox="0 0 100 100"><circle cx="10" cy="10" r="8" fill="#00d4ff"/><circle cx="32" cy="10" r="8" fill="#4a6a8a"/><circle cx="54" cy="10" r="8" fill="#00d4ff"/><circle cx="76" cy="10" r="8" fill="#4a6a8a"/><circle cx="98" cy="10" r="8" fill="#00d4ff"/><circle cx="10" cy="32" r="8" fill="#4a6a8a"/><circle cx="32" cy="32" r="8" fill="#00d4ff"/><circle cx="54" cy="32" r="8" fill="#4a6a8a"/><circle cx="76" cy="32" r="8" fill="#00d4ff"/><circle cx="98" cy="32" r="8" fill="#4a6a8a"/><circle cx="10" cy="54" r="8" fill="#00d4ff"/><circle cx="32" cy="54" r="8" fill="#4a6a8a"/><circle cx="54" cy="54" r="8" fill="#00d4ff"/><circle cx="76" cy="54" r="8" fill="#4a6a8a"/><circle cx="98" cy="54" r="8" fill="#00d4ff"/><circle cx="10" cy="76" r="8" fill="#4a6a8a"/><circle cx="32" cy="76" r="8" fill="#00d4ff"/><circle cx="54" cy="76" r="8" fill="#4a6a8a"/><circle cx="76" cy="76" r="8" fill="#00d4ff"/><circle cx="98" cy="76" r="8" fill="#4a6a8a"/><circle cx="10" cy="98" r="8" fill="#00d4ff"/><circle cx="32" cy="98" r="8" fill="#4a6a8a"/><circle cx="54" cy="98" r="8" fill="#00d4ff"/><circle cx="76" cy="98" r="8" fill="#4a6a8a"/><circle cx="98" cy="98" r="8" fill="#00d4ff"/></svg><span style="font-size:120px;font-weight:900;letter-spacing:5px;white-space:nowrap;font-family:Arial Black,Impact,sans-serif;color:#00d4ff;">NERAI</span></div></div>""", unsafe_allow_html=True)
