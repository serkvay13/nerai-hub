...
def render_briefing_room():
    ...
    st.markdown('<div class="h-div" style="margin:24px 0 16px"></div>', unsafe_allow_html=True)
    st.markdown('<div class="sec-hdr">🏛️ NERAI Strategic Analysis Lab</div>', unsafe_allow_html=True)
    st.markdown("""
    ...
    with _tt_col2:
        _tt_generate = st.button("📝 Generate Report", type="primary", use_container_width=True, key="tt_gen_btn")
