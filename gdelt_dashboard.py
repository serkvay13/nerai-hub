...
def render_home():
    ...
    # === 3D GLOBE ===
    st.markdown("""<style>[data-testid="stAppViewContainer"]{background:#060d18 !important}.main .block-container{background:#060d18 !important;padding-top:1rem !important}.main{background:#060d18 !important}section[data-testid="stSidebar"]{background:#0a1020 !important}[data-testid="stVerticalBlock"]{background:transparent !important}[data-testid="stHorizontalBlock"]{background:transparent !important}iframe[title="streamlit_app.static.index"]{background:transparent !important}.stHtml{background:transparent !important}[data-testid="stHtml"]{background:transparent !important}.stMarkdown{background:transparent !important}.element-container{background:transparent !important}header[data-testid="stHeader"]{background:#060d18 !important}</style>""", unsafe_allow_html=True)
    _globe_html = """
<div style="width:100%;height:510px;background:transparent;display:flex;align-items:center;justify-content:center;overflow:hidden">
...
var bg=X.createLinearGradient(0,0,0,H);bg.addColorStop(0,"#060d18");bg.addColorStop(0.5,"#0a1525");bg.addColorStop(1,"#060d18");X.fillStyle=bg;X.fillRect(0,0,W,H);
...
var sa=(t*0.0008)%(6.28);X.strokeStyle="rgba(0,212,170,0.1)";X.lineWidth=1.5;X.beginPath();X.arc(cx,cy,R*1.06,sa,sa+0.8);X.stroke();
